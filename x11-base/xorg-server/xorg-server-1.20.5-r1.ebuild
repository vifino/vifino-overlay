...
UPSTREAMED_PATCHES=(
	...
	"${FILESDIR}"/${PN}-1.21-fix-for-glvnd-1.2.0-1.patch
	"${FILESDIR}"/${PN}-1.21-fix-for-glvnd-1.2.0-2.patch
	"${FILESDIR}"/${PN}-1.21-replace-MESA_EGL_NO_X11_HEADERS-hack-with-upstream-E.patch
)
